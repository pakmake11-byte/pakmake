...
export function ContactForm() {
  ...
  // Smooth, slow easing for both entry and exit
  const easeInOutCustom: Easing = [0.65, 0, 0.35, 1]
  ...
  const itemVariantsLeft: Variants = {
    ...
    visible: {
      opacity: 1,
      x: 0,
      transition: { duration: 1.2, ease: easeInOutCustom },
    },
    exit: {
      opacity: 0,
      x: -60,
          ...
          <div className="w-full max-w-2xl">
            <div className="relative bg-gradient-to-br from-white to-primary-50 rounded-3xl shadow-2xl p-8 sm:p-12 overflow-hidden">
              <motion.div
                ...
                animate={{ scale: 1 }}
                exit={{ scale: 0 }}
                transition={{ delay: 0.5, duration: 1, ease: easeInOutCustom }}
              ...
              <motion.div
                ...
                animate={{ scale: 1 }}
                exit={{ scale: 0 }}
                transition={{ delay: 0.6, duration: 1, ease: easeInOutCustom }}
              ...
              <div className="relative z-10 text-center">
                <motion.div
                  ...
                  transition={{ delay: 0.7, duration: 1, ease: easeInOutCustom }}
